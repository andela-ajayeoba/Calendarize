        ...
        return {
            getSampleData: function() {
                return [
                        ...
                        {
                          name: 'Milestones', height: '3em', sortable: {enabled: false}, classes: 'gantt-row-milestone', color: '#45607D', 
                          tasks: [
                            // Dates can be specified as string, timestamp or javascript date object. The data attribute can be used to attach a custom object
                            {name: 'Kickoff', color: '#93C47D', from: '2013-10-07T09:00:00', to: '2013-10-12T10:00:00', data: 'Can contain any custom data or object'},
                        ...
                        {
                          name: 'Kickoff', movable: {allowResizing: false}, 
                          tasks: [
                        ...
                        {
                          name: 'Sprint 1', tooltips: {enabled: false}, 
                          // tasks: [
