...
angular.module('angular-person-timeline', [])
  .directive('timeline', function(Apicall) {
    ...
    return {
      ...
      link: function($scope, $element) {
        Apicall.Assignments.query(function(res){
        ...
        $scope.$watch('model', function(newVal, oldVal, model) {
          ...
          for (var index in newVal) {
            ...
            if(newVal[index].assignmentID){
              ...
              Apicall.Assignments.get({assignmentId: newVal[index].assignmentID}, function(res){
