...
(function() {
	...
	describe('Calendarizes Controller Tests', function() {
		...
		it('$scope.listProjects() should return an array with at least one Project object fetched from XHR', inject(function(Apicall) {
		...
		it('$scope.findOneProject() should return an array with one Project object fetched from XHR using a projectId URL parameter', inject(function(Apicall) {
		...
		it('$scope.removeProject() should send a DELETE request with a valid projectId and remove the Project from the scope', inject(function(Apicall) {
