...
// (function() {
// 	describe('Projects modal Controller Tests', function() {
...
// 		beforeEach(inject(function($controller, $scope, _$location_, _$stateParams_, _$httpBackend_) {
...
// 		it('$scope.findProjects() should return an array with at least one Project object fetched from XHR', inject(function(Apicall) {
